...
public class Main {
    ...
    static public void main(String[] args) {
        ...
        BigDecimal[][] matr = new BigDecimal[n][n];
        BigDecimal[] vector = new BigDecimal[n];

        read(matr, vector, "input.txt");
        ComputationalMethods.SLEAresult result = methods.methodGauss(matr, vector);
        ...
        display(result.getInversedMatrix());
        System.out.println();

        System.out.println("Обратная матрица, умноженная на исходную:");
        displayE(methods.multiply(result.getInversedMatrix(), matr));
        System.out.println();
    }
}